...
var http = require("http"), https = require("https"), require$$0 = require("tty"), require$$1 = require("util"), defaultOptionsValidator = require("./_chunks-cjs/defaultOptionsValidator.cjs"), progressStream = require("progress-stream"), allowed = require("is-retry-allowed");
